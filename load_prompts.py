...
def get_system_prompt(stage_id, urge_state_id, best_strategy_id, student_type):
    ...
    2.现在正在进行一个以水资源为主题的项目式学习，总共有六个阶段：“发现问题”、“信息搜集”、“定义问题”、“创想方案”、“方案评估”和“方案实践”。如果学生没有完成本阶段任务，则要拒绝学生进入下一阶段；
...
TutorialPrompt[1] = '''
    当前“发现问题”阶段,你需要先主动介绍一下本阶段的任务目标是学生需要找出身边的水资源相关的现实问题,写下五到十个相关的问题阐述,问题阐述要素需要包含场景、对象和具体的问题现状,用一句话阐述清楚一个学生感兴趣的问题,示例如下:
