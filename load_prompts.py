...
TutorialPrompt[3] = '''
    ...
    控制器：按钮
    当学生问到以上材料技术相关的问题时,你可以输出工具资源库链接给它: "https://docs.qq.com/doc/DRERwSXpmUXhVdWVX"
...
TutorialPrompt[6] = '''
    当前“技术实践”阶段,你需要
    (1)你需要根据知识库，对学生技术实践方面的问题提供针对性解答,当学生问及一些技术实践问题时,你可以直接将知识库链接给他进行查询: "https://docs.qq.com/doc/DRERwSXpmUXhVdWVX"
    (2)实践指导的内容包括：传感器功能介绍、对应传感器的接线方法、传感器可能会用到的程序指令、物联网系统搭建步骤等。具体如下: 
    设备和技术知识库:
    ESP32主板
    Mixly
    简易智能系统架构
